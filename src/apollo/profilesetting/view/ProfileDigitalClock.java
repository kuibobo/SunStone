...
public class ProfileDigitalClock extends LinearLayout {
	...
	public ProfileDigitalClock(Context context) {
		this(context, null);
	}

	public ProfileDigitalClock(Context context, AttributeSet attrs) {
		super(context, attrs);
